...
# DUPLICATE REMOVED: @discovery_advanced_bp.route("/api/discovery/search_history", methods=["GET"])
# DUPLICATE REMOVED: def clear_search_history():
# DUPLICATE REMOVED:     """Clear search history"""
# DUPLICATE REMOVED:     try:
# DUPLICATE REMOVED:         SEARCH_HISTORY_FILE.write_text(json.dumps({"searches": []}, indent=2))
...
# DUPLICATE REMOVED: 
# DUPLICATE REMOVED: def save_search_history(query, filters):
