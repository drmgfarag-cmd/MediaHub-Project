...
@advanced_ui_bp.route('/api/ui/preferences', methods=['POST'])
...
@advanced_ui_bp.route('/api/ui/notifications', methods=['POST'])
...
@advanced_ui_bp.route('/api/ui/dashboard/layouts', methods=['POST'])
...
@advanced_ui_bp.route('/api/ui/keyboard-shortcuts', methods=['POST'])
