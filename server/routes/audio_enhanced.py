...
@audio_enhanced_bp.route('/api/audio/config', methods=['POST'])
def update_config():
...
@audio_enhanced_bp.route('/api/audio/library/tracks', methods=['GET'])
def get_tracks():
...
@audio_enhanced_bp.route('/api/audio/playlists', methods=['POST'])
def create_playlist():
