...
@dashboard_custom_bp.route('/api/dashboard/config', methods=['POST'])
...
@dashboard_custom_bp.route('/api/dashboard/tree/<category>/nodes/<node_id>', methods=['DELETE'])
...
@dashboard_custom_bp.route('/api/dashboard/layout', methods=['POST'])
