...
def fetch():
    ...
    if not tarball:
        r2=requests.get('https://registry.npmjs.org/monaco-editor/latest', timeout=30)
    ...
    src=os.path.join(DST,'package','min','vs')
    if os.path.exists(src):
        target=os.path.join(DST,'vs')
